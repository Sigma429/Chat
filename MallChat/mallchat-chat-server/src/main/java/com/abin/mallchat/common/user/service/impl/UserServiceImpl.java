...
public class UserServiceImpl implements UserService {
    ...
    public List<BadgeResp> badges(Long uid) {
        ...
        // 查询用户拥有的徽章
        List<UserBackpack> backpacks = userBackpackDao.getByItemIds(uid,
    ...
    private List<Long> getNeedSyncUidList(List<SummeryInfoReq.infoReq> reqList) {
        ...
        List<Long> userModifyTime =
                userCache.getUserModifyTime(reqList.stream().map(SummeryInfoReq.infoReq::getUid).collect(Collectors.toList()));
